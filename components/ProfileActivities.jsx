    ...
    return <>
        ...
        <div className={Style.buttonContainer}>
            ...
            <div className={Style.choiceBlock}>
                <h1 style={{ fontSize: "27px", textAlign: "center" }}>Check out a workout</h1>
                <span className={Style.span}>Choose a plan from a few of our available workouts.</span>
            ...
            <div className={Style.choiceBlock}>
                <h1 style={{ fontSize: "27px", textAlign: "center" }}>Feeling creative?</h1>
            ...
            <div className={Style.choiceBlock}>
                <h1 style={{ fontSize: "27px", textAlign: "center" }}>Browse custom workouts</h1>
