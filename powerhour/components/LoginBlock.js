    ...
    return <>
        <div className={Style.loginBlock}>
            ...
            <div className={Style.usernameBlock}>
                ...
                <input required pattern=".*\S.*" type="text" className={Style.usernameInput} onClick={handleClickUsername}></input>
            ...
            <div className={Style.passwordBlock}>
                ...
                <input required pattern=".*\S.*" type="password" className={Style.passwordInput} onClick={handleClickPassword} ></input>
